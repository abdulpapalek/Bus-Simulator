  ...
  rotatePosition: function (position) {
    ...
    switch (position) {
      case constant.RIGHT:
        ...
        constant.CARDINALDIRECTIONS[(index + constant.CARDINALDIRECTIONS.length - 1) % constant.CARDINALDIRECTIONS.length]
        break
      case constant.LEFT:
        state.cardinaldirection = constant.CARDINALDIRECTIONS[(index + 1) % constant.CARDINALDIRECTIONS.length]
        break
      default:
        break
    }
